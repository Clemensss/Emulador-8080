...
int disseble8080(unsigned char *buffer, int pc)
{
	...
	case 0x22: printf("NOP"); break; //dont know yet
	...
	case 0x2a: printf("LHLD adr"); break; //dont know yet
	...
	case 0x32: printf("STA   adr"); break; //dont know yet
	...
	case 0x3a: printf("LHA  adr"); break; //dont know yet
